...
const (
	UserService_GetUser_FullMethodName                   = "/ginbot.v1.UserService/GetUser"
	UserService_Register_FullMethodName                  = "/ginbot.v1.UserService/Register"
	UserService_GetCongratulableBirthdays_FullMethodName = "/ginbot.v1.UserService/GetCongratulableBirthdays"
	UserService_SetLocale_FullMethodName                 = "/ginbot.v1.UserService/SetLocale"
	UserService_SetTimezone_FullMethodName               = "/ginbot.v1.UserService/SetTimezone"
)
...
func _UserService_GetCongratulableBirthdays_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(UserServiceServer).GetCongratulableBirthdays(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ginbot.v1.UserService",
