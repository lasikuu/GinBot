...
const (
	ReminderService_GetReminder_FullMethodName     = "/ginbot.v1.ReminderService/GetReminder"
	ReminderService_ListReminders_FullMethodName   = "/ginbot.v1.ReminderService/ListReminders"
	ReminderService_CreateReminder_FullMethodName  = "/ginbot.v1.ReminderService/CreateReminder"
	ReminderService_UpdateReminder_FullMethodName  = "/ginbot.v1.ReminderService/UpdateReminder"
	ReminderService_DeleteReminder_FullMethodName  = "/ginbot.v1.ReminderService/DeleteReminder"
	ReminderService_ConfirmDelivery_FullMethodName = "/ginbot.v1.ReminderService/ConfirmDelivery"
)
...
func _ReminderService_ConfirmDelivery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmDeliveryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReminderServiceServer).ConfirmDelivery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReminderService_ConfirmDelivery_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReminderServiceServer).ConfirmDelivery(ctx, req.(*ConfirmDeliveryReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReminderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ginbot.v1.ReminderService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ReminderService_ConfirmDelivery_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "ginbot/v1/reminder.proto",
}
